...
class HTMLFeatureField extends NewHTMLCheckField {
	...
	private $isAutoEnroll = false;
	private $classes = array(
		'header' => 'mw-ui-feature-header',
		'title' => 'mw-ui-feature-title',
		'field' => 'mw-ui-feature-field',
	);
	...
	function __construct( $options ) {
		...
		if ( $options['fieldname'] === 'betafeatures-auto-enroll' ) {
			$this->isAutoEnroll = true;
			$this->classes['header'] = 'mw-ui-autoenroll-header';
			$this->classes['field'] = 'mw-ui-autoenroll-field';
			$this->classes['title'] = '';
		}
	}
